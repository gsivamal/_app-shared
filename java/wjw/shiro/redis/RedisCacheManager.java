...
public class RedisCacheManager<T> implements CacheManager, Initializable, Destroyable {
  ...
  public <K, V> Cache<K, V> getCache(String name) throws CacheException {
    ...
    if (c == null) {
     ...
     //salai  c = new RedisCache<K, V>(redisManager);
      c = new RedisCache<K, V>();

      // add it to the cache collection
      //salai caches.put(name, c);
      caches.put(name, c);
    }
    return c;
  }

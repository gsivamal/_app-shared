        ...
        if (staticResourceHandlers != null) {
            for (AbstractResourceHandler staticResourceHandler : staticResourceHandlers) {
                ...
                if (resource != null && resource.isReadable()) {
                	...
                	//salai : @todo, come back here and check...
    ...
    public static void configureStaticResources(String folder) {
        ...
        if (!staticResourcesSet) {
            try {
                ...
                ClassPathResourceHandler crHandler =  new ClassPathResourceHandler(folder, "index.html");
                
                //salai: add diskpath handler may be here...
                
                staticResourceHandlers.add(crHandler);
